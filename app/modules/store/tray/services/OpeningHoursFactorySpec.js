...
describe('Test OpeningHoursFactory', function() {
  ...
  describe('Test the getNext function', function() {
    it('Case 1:', function () {
      ...
      expect(openingHours.getNext(540, 60)).toEqual(690);
    });

    it('Case 2:', function () {
      var date = new Date(monday.getTime());
      var openingHours = new OpeningHoursFactory(TestData.memmingenDeliveryTimeCollection);
      expect(openingHours.getNext(660, 60)).toEqual(720);
    });

    it('Case 3:', function () {
      var date = new Date(monday.getTime());
      var openingHours = new OpeningHoursFactory(TestData.memmingenDeliveryTimeCollection);
      expect(openingHours.getNext(750, 60)).toEqual(810);
    });

    it('Case 4:', function () {
      var date = new Date(monday.getTime());
      var openingHours = new OpeningHoursFactory(TestData.memmingenDeliveryTimeCollection);
      expect(openingHours.getNext(770, 60)).toEqual(830);
    });

    it('Case 5:', function () {
      var date = new Date(monday.getTime());
      var openingHours = new OpeningHoursFactory(TestData.memmingenDeliveryTimeCollection);
      expect(openingHours.getNext(1080, 60)).toEqual(1140);
    });

    it('Case 6:', function () {
      var date = new Date(monday.getTime());
      var openingHours = new OpeningHoursFactory(TestData.memmingenDeliveryTimeCollection);
      expect(openingHours.getNext(1290, 60)).toEqual(690);
    });
  });
